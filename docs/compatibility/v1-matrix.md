...
Candidate matrix updated 2026-08-10. “Verified” means both the applicable
...
| Streamer.bot | **1.0.7 stable** | Exact CPH fingerprint, managed build, stable-v23 package validation, five-profile mock matrix, deterministic package and publishing validation | DLL installation, import, compiler reference, compilation, action execution/log, Healthy status, update, modified-file protection, repair, rollback, and uninstall | Verified |
...
- Streamer.bot 1.0.7 support applies to the exact stable release. Later stable
  releases require a separate compatibility refresh.
